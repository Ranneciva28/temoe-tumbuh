...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink);background:var(--paper);font-size:16px;overflow-x:hidden}a{text-decoration:none;color:inherit}button,input{font:inherit}.wrap{width:min(1180px,calc(100% - 48px));margin:auto}.announcement{background:var(--forest-deep);color:#eef6ed;text-align:center;padding:10px 18px;font-size:13px;font-weight:700;letter-spacing:.15px}.announcement span{color:var(--lime)}.nav{height:82px;display:flex;align-items:center;justify-content:space-between;gap:24px}.brand{display:flex;align-items:center;gap:11px;font-size:22px;font-weight:850;letter-spacing:-.7px}.brand-mark{width:38px;height:38px;border-radius:13px 13px 18px 18px;background:var(--lime);display:grid;place-items:center;color:var(--forest-deep);font-size:21px;transform:rotate(-3deg)}.nav-links{display:flex;align-items:center;gap:26px;color:#496159;font-size:14px;font-weight:700}.nav-links a:hover{color:var(--forest)}.nav-cta,.btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;border-radius:14px;font-weight:800;transition:transform .2s ease,box-shadow .2s ease,background .2s ease}.nav-cta{padding:11px 16px;background:var(--forest);color:#fff;font-size:13px;box-shadow:0 8px 22px rgba(36,88,69,.18)}.nav-cta:hover,.btn:hover{transform:translateY(-2px)}
        ...
        @media(max-width:980px){.nav-links{display:none}.hero{padding:42px;grid-template-columns:1fr;min-height:auto}.hero-visual{min-height:470px}.trust-strip{grid-template-columns:1fr 1fr}.trust-item:nth-child(2){border-right:0}.trust-item:nth-child(-n+2){border-bottom:1px solid var(--line)}.promise-grid,.program-grid{grid-template-columns:1fr}.promise{min-height:auto}.program{min-height:275px}.story-grid,.parent-card,.fit-grid{grid-template-columns:1fr}.gallery-grid{grid-template-columns:1fr 1fr;grid-template-rows:330px 230px}.gallery-card:first-child{grid-column:1/3;grid-row:auto}.parent-card{padding:42px}.custom-inner,.custom-section:nth-of-type(even) .custom-inner{grid-template-columns:1fr;direction:ltr}}
        @media(max-width:640px){.wrap{width:calc(100% - 30px);max-width:1180px}.announcement{font-size:12px}.nav{height:69px}.brand{font-size:19px}.brand-mark{width:34px;height:34px}.nav-cta{padding:10px 13px}.hero-shell{border-radius:25px}.hero{padding:29px 21px 35px;gap:34px}.hero h1{font-size:45px;letter-spacing:-2.2px}.hero p{font-size:16px}.hero-notes{display:grid;gap:10px}.hero-visual{min-height:390px}.photo-frame{inset:0 4px 10px}.photo-placeholder{min-height:375px}.float-one{left:-7px;bottom:30px}.float-two{right:-5px;top:22px}.scribble{width:68px;height:68px;right:1px}.trust-strip{grid-template-columns:1fr;margin-top:14px}.trust-item{border-right:0;border-bottom:1px solid var(--line)!important}.trust-item:last-child{border-bottom:0!important}.section{padding:70px 0}.section-head h2{font-size:37px;letter-spacing:-1.4px}.promise,.program{padding:23px}.story-grid{gap:36px}.story-photo,.story-photo .photo-placeholder{min-height:420px}.gallery-grid{display:grid;grid-template-columns:1fr;grid-template-rows:none}.gallery-card:first-child{grid-column:auto;min-height:360px}.gallery-card{min-height:230px}.parent-card{padding:30px 20px;border-radius:25px}.parent-points{grid-template-columns:1fr}.fit-highlight{transform:none}.custom-copy h2{font-size:36px}.final{padding:52px 23px;border-radius:25px}.footer-inner{display:block}.footer-links{margin-top:17px;flex-wrap:wrap}.actions .btn{width:100%}}
...
$knownKeys = ['hero','daily_rhythm','space_play','space_rest','parent_updates'];
$customSections = $sections->reject(fn ($section) => in_array($section->section_key, $knownKeys, true));
@endphp

<div class="announcement"><span>Founding Families</span> · Priority slot untuk keluarga Cilegon & Serang sedang dibuka</div>
<header class="wrap">
    <nav class="nav" aria-label="Navigasi utama">
        <a class="brand" href="{{ route('home') }}"><span class="brand-mark">🌱</span><span>Temoe Tumbuh</span></a>
        <div class="nav-links"><a href="#program">Program</a><a href="#pengalaman">Pengalaman Anak</a><a href="#orang-tua">Untuk Orang Tua</a><a href="#faq">FAQ</a></div>
        <a class="nav-cta" href="{{ $interestUrl }}">Daftar Minat <span>→</span></a>
    </nav>
</header>
...
<main>
    <div class="wrap">
        <section class="hero-shell">
            <div class="hero">
                <div>
                    <span class="eyebrow"><span class="eyebrow-dot"></span> Daycare hangat di Cilegon & Serang</span>
                    <h1>{{ $hero?->title ?: 'Tempat kecil untuk cerita tumbuh yang besar.' }}</h1>
                    <p>{{ $hero?->subtitle ?: 'Hari-hari yang penuh bermain, rasa aman, dan stimulasi bermakna—supaya anak tumbuh bahagia dan orang tua melangkah lebih tenang.' }}</p>
                    <div class="actions">
                        <a class="btn btn-primary" href="{{ $withAttribution($hero?->cta_url ?: route('interest.create')) }}">{{ $hero?->cta_label ?: 'Amankan Priority Slot' }} <span>→</span></a>
                        <a class="btn btn-light" href="#pengalaman">Lihat keseharian anak</a>
                    </div>
                    <div class="hero-notes"><span><i class="check">✓</i> Aktivitas sesuai tahap tumbuh</span><span><i class="check">✓</i> Kabar harian untuk orang tua</span></div>
                </div>
                <div class="hero-visual">
                    ...
                    <div class="float-card float-two"><span class="float-icon">💬</span><strong>Orang tua tetap dekat</strong><small>Update momen penting setiap hari</small></div>
                    <div class="scribble">PLAY<br>LEARN<br>GROW</div>
                </div>
            </div>
        </section>
        <div class="trust-strip">
            <div class="trust-item"><span class="trust-icon">🧸</span><div><strong>Usia toddler–preschool</strong><small>Aktivitas mengikuti fase anak</small></div></div>
    ...
    <section class="section" id="pengalaman">
        <div class="wrap">
            <div class="section-head"><span class="section-kicker">Rasa aman untuk tumbuh</span><h2>Bukan sekadar tempat menunggu orang tua pulang.</h2><p>Setiap bagian hari dirancang supaya anak merasa dikenal, berani mencoba, dan pulang membawa cerita baru.</p></div>
    ...
    <section class="section program-bg" id="program">
        <div class="wrap">
            <div class="section-head center"><span class="section-kicker">Program bertahap</span><h2>Satu ruang, banyak cara untuk bertumbuh.</h2><p>Kelompok aktivitas disusun mengikuti kebutuhan perkembangan, bukan sekadar membagi anak berdasarkan umur.</p></div>
            <div class="program-grid">
                <article class="program"><span class="program-age">Toddler</span><h3>Little Explorer</h3><p>Hari-hari pertama mengenal lingkungan, rutinitas, emosi, dan dunia lewat seluruh indera.</p><ul class="program-list"><li>Sensory & messy play</li><li>Gerak dan koordinasi dasar</li><li>Bahasa lewat lagu & cerita</li></ul></article>
                <article class="program"><span class="program-age">Early Years</span><h3>Curious Creator</h3><p>Ruang untuk banyak bertanya, mencoba ide, membangun pertemanan, dan mengekspresikan diri.</p><ul class="program-list"><li>Creative project & pretend play</li><li>Problem solving sederhana</li><li>Social-emotional practice</li></ul></article>
                <article class="program"><span class="program-age">Preschool</span><h3>Growing Independent</h3><p>Persiapan lembut menuju fase sekolah dengan kemandirian, rasa ingin tahu, dan percaya diri.</p><ul class="program-list"><li>Pre-literacy & numeracy</li><li>Daily life skills</li><li>Kolaborasi dan komunikasi</li></ul></article>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="wrap story-grid">
            ...
            <div>
                ...
                <div class="section-head" style="margin-bottom:0"><h2>{{ $daily?->content ?: 'Hari yang terarah, tanpa kehilangan serunya bermain.' }}</h2><p>Jadwal akan menyesuaikan usia dan kebutuhan anak, dengan alur yang membantu mereka merasa aman karena tahu apa yang terjadi selanjutnya.</p></div>
                <div class="timeline">
    ...
    <section class="section" id="orang-tua">
        <div class="wrap parent-card">
            <div>
                <span class="section-kicker">Orang tua tetap terhubung</span>
                <div class="section-head" style="margin-bottom:0"><h2>{{ $parentUpdates?->title ?: 'Lo tetap jadi bagian dari hari mereka.' }}</h2><p>{{ $parentUpdates?->subtitle ?: 'Momen penting, aktivitas, makan, tidur, dan catatan hariannya dirangkum agar orang tua tidak merasa kehilangan cerita.' }}</p></div>
    ...
    <section class="section" style="padding-top:15px">
        <div class="wrap fit-grid">
            <div class="fit-card"><span class="section-kicker">Cocok untuk keluarga lo?</span><h3>Temoe Tumbuh bisa jadi pilihan kalau…</h3><div class="fit-list"><div class="fit-row"><span class="fit-check">✓</span><div><strong>Lo mencari lingkungan yang hangat, bukan terasa institusional</strong><small>Anak dipandang sebagai pribadi dengan ritme dan kebutuhan yang berbeda.</small></div></div><div class="fit-row"><span class="fit-check">✓</span><div><strong>Lo ingin kegiatan yang menyenangkan sekaligus bermakna</strong><small>Bermain tetap menjadi cara utama anak mengenal dunia.</small></div></div><div class="fit-row"><span class="fit-check">✓</span><div><strong>Lo ingin komunikasi yang terbuka dan mudah dipahami</strong><small>Tidak perlu menebak-nebak bagaimana hari anak berjalan.</small></div></div><div class="fit-row"><span class="fit-check">✓</span><div><strong>Lo butuh pilihan jadwal yang lebih dekat dengan ritme keluarga</strong><small>Kebutuhan keluarga pendaftar menjadi dasar prioritas program awal.</small></div></div></div></div>
            <aside class="fit-highlight"><h3>Mulai dari kebutuhan keluarga, bukan asumsi kami.</h3><p>Ceritakan usia anak, area yang nyaman, jadwal, dan ekspektasi lo. Jawaban ini membantu kami memprioritaskan layanan Temoe Tumbuh yang paling relevan.</p><a class="btn" href="{{ $interestUrl }}">Ceritakan kebutuhan keluarga →</a></aside>
        </div>
    </section>

    <section class="section" id="faq">
        <div class="wrap"><div class="section-head center"><span class="section-kicker">Pertanyaan orang tua</span><h2>Yang mungkin ingin lo tanyakan.</h2><p>Kami rangkum hal-hal penting sebelum keluarga bergabung sebagai Founding Families.</p></div><div class="faq-list">
            <details><summary>Temoe Tumbuh akan hadir di area mana?</summary><p>Fokus pertama kami adalah Cilegon dan Serang. Area final akan diprioritaskan berdasarkan konsentrasi kebutuhan keluarga yang masuk melalui formulir minat.</p></details>
            <details><summary>Usia berapa yang bisa bergabung?</summary><p>Program awal diarahkan untuk usia toddler hingga preschool. Pembagian kelompok dan kapasitas akan disesuaikan agar aktivitas tetap nyaman dan relevan untuk setiap tahap perkembangan.</p></details>
            <details><summary>Apakah tersedia full day dan half day?</summary><p>Ya, keduanya menjadi pilihan program yang sedang dipersiapkan. Kami juga memetakan kebutuhan beberapa hari per minggu dan jadwal fleksibel dari keluarga pendaftar.</p></details>
            <details><summary>Apakah mengisi formulir berarti wajib mendaftar?</summary><p>Tidak. Formulir minat belum menjadi transaksi atau kewajiban membeli. Lo akan mendapat informasi lebih awal saat area, jadwal, paket, dan tahap reservasi sudah siap.</p></details>
            <details><summary>Apa keuntungan menjadi Founding Families?</summary><p>Founding Families mendapat prioritas informasi dan kesempatan awal saat slot reservasi dibuka, sekaligus membantu membentuk layanan yang paling dibutuhkan keluarga Cilegon–Serang.</p></details>
        </div></div>
    </section>
    ...
    <div class="wrap final-wrap"><section class="final"><div class="final-content"><span class="section-kicker">Founding Families</span><h2>Tempat tumbuh yang lo cari bisa dimulai dari sini.</h2><p>Bagikan kebutuhan keluarga dan dapatkan priority update untuk lokasi, program, harga, serta pembukaan slot pertama Temoe Tumbuh.</p><a class="btn" href="{{ $interestUrl }}">Daftar Minat Temoe Tumbuh →</a></div></section></div>
</main>

<footer class="footer"><div class="wrap footer-inner"><div class="footer-brand"><a class="brand" href="{{ route('home') }}"><span class="brand-mark">🌱</span><span>Temoe Tumbuh</span></a><small>Little days. Big growth stories.</small></div><div class="footer-links"><a href="#program">Program</a><a href="#orang-tua">Untuk Orang Tua</a><a href="{{ route('privacy') }}">Privasi</a><span>Cilegon · Serang</span></div></div></footer>
</body>
</html>
